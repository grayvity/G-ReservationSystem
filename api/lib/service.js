...
async function get_order_info(search_info) {
  try {
    ...
    while(current_date <= enddate){
      cur_day = (current_date.getUTCMonth() + 1) + '/' + current_date.getUTCDate();
      range_days.push({ date : current_date, day: cur_day, weekday: weekday(current_date.getDay()) });
      current_date = current_date + 1;
    }
    orders = [{ roomName: 'ger#1', begindate: '2018/11/10', enddate: '2018/11/12', order_status: 1, note : 'bla'},
    { roomName: 'ger#2', begindate: '2018/11/11', enddate: '2018/11/12', order_status: 2, note : 'bla'},
    { roomName: 'ger#2', begindate: '2018/11/14', enddate: '2018/11/18', order_status: 1, note : 'bla'},
    { roomName: 'ger#3', begindate: '2018/11/16', enddate: '2018/11/16', order_status: 1, note : 'bla'},
    { roomName: 'ger#4', begindate: '2018/11/10', enddate: '2018/11/15', order_status: 2, note : 'bla'},
    { roomName: 'ger#4', begindate: '2018/11/16', enddate: '2018/11/17', order_status: 1, note : 'bla'},]
    list_orders = []
    rooms = []
    for (order in orders){
