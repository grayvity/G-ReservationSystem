<template>
  ...
  <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item" v-if="get_role === 'admin'">
        <a
          class="nav-link"
        ...
        >
          ...
          <span class="menu-title">Бүртгэл</span>
          <i class="menu-arrow"></i>
        </a>
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <router-link class="nav-link" v-bind:to="{ name: 'rooms'}">
                <i class="menu-icon fa fa-home"></i>
                <span class="menu-title">Гэр / байшин</span>
              </router-link>
            </li>
            <li class="nav-item">
...
export default {
  ...
  computed: {
    get_role() {
      return this.$store.getters.get_logged_user.role;
    }
  }
};
</script>