...
export const store = new Vuex.Store({
  state: {
    ...
    logged_user: { username: localStorage.getItem("username") || '', role: localStorage.getItem("role") || '' },
    is_loading: false
  },
  ...
  mutations: {
    ...
    set_logged_user: (state, logged_user) => {
      ...
      localStorage.setItem("username", logged_user.username);
      localStorage.setItem("role", logged_user.role);
    }
  },
  actions: {
